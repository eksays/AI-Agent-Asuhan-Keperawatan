...
export function Dashboard() {
  const { creds, tab, setTab, sessions, activeId, messages, newChat, selectSession, sidebarOpen, setSidebarOpen, settingsOpen, setSettingsOpen, send, banner, dismissBanner, logoutCreds, hardReset, changeName, deleteMyData, capabilities, capabilityAvailable, capabilityReason } = useApp();
