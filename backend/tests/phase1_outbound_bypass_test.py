...
ALLOWLIST = {
    ...
    ("api.py", 487, "ChatAnthropic("): "Raw provider construction is private and wrapped by get_llm().",
    ("api.py", 487, "Anthropic("): "Substring match inside ChatAnthropic; same reviewed raw provider construction.",
    ("api.py", 490, "ChatGoogleGenerativeAI("): "Raw provider construction is private and wrapped by get_llm().",
    ("api.py", 497, "ChatOpenAI("): "Raw provider construction is private and wrapped by get_llm().",
