...
ALLOWLIST = {
    ...
    ("api.py", 540, "ChatAnthropic("): "Raw provider construction is private and wrapped by get_llm().",
    ("api.py", 540, "Anthropic("): "Substring match inside ChatAnthropic; same reviewed raw provider construction.",
    ("api.py", 543, "ChatGoogleGenerativeAI("): "Raw provider construction is private and wrapped by get_llm().",
    ("api.py", 550, "ChatOpenAI("): "Raw provider construction is private and wrapped by get_llm().",
