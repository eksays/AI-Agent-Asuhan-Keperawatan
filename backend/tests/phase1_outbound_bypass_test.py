...
ALLOWLIST = {
    ...
    ("api.py", 391, "ChatAnthropic("): "Raw provider construction is private and wrapped by get_llm().",
    ("api.py", 391, "Anthropic("): "Substring match inside ChatAnthropic; same reviewed raw provider construction.",
    ("api.py", 394, "ChatGoogleGenerativeAI("): "Raw provider construction is private and wrapped by get_llm().",
    ("api.py", 401, "ChatOpenAI("): "Raw provider construction is private and wrapped by get_llm().",
