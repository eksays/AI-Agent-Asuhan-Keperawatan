...
ALLOWLIST = {
    ...
    ("api.py", 529, "ChatAnthropic("): "Raw provider construction is private and wrapped by get_llm().",
    ("api.py", 529, "Anthropic("): "Substring match inside ChatAnthropic; same reviewed raw provider construction.",
    ("api.py", 532, "ChatGoogleGenerativeAI("): "Raw provider construction is private and wrapped by get_llm().",
    ("api.py", 539, "ChatOpenAI("): "Raw provider construction is private and wrapped by get_llm().",
